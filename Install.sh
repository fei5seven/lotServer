...
function Install()
{
  ...
  wget --no-check-certificate -qO "${AcceTmp}/etc/apx.lic" "https://apx.mltd.site/keygen.php?ver=${acce_ver}&mac=${Mac}"
  ...
  bash "${AcceRoot}/install.sh" -in 2000000 -out 2000000 -t 0 -r -b -i ${Eth}
