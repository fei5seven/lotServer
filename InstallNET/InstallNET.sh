...
[[ "$ddMode" == '1' ]] && {
  export SSL_SUPPORT='https://raw.githubusercontent.com/fei5seven/lotServer/master/InstallNET/wget_udeb_amd64';
  if [[ -n "$tmpURL" ]]; then
    DDURL="$tmpURL"
...
[[ -z "$myPASSWORD" ]] && myPASSWORD='$1$G0WQCSZt$Df96HONU.P5LCj3CyNJqV0';
